...
<style scoped>
.attention-workspace{max-width:68rem;margin:0 auto;color:#2c3e50}.attention-workspace>header{display:flex;align-items:flex-start;justify-content:space-between;gap:var(--space-inline-lg);margin-bottom:var(--space-stack-xl)}.eyebrow,.item-type{margin:0 0 var(--space-stack-xs);text-transform:uppercase;letter-spacing:.08em;color:#64748b;font-size:.72rem;font-weight:700}.attention-workspace h1{font-size:1.7rem;margin:0}.attention-workspace>header p:not(.eyebrow){margin:var(--space-stack-xs) 0;color:#64748b}.refresh,.primary{border-radius:.6rem;padding:.65rem .85rem;font-weight:700}.refresh{border:1px solid #cbd5e1;background:#fff;color:#334155}.primary{border:1px solid #2563eb;background:#2563eb;color:white;white-space:nowrap}.primary span{font-size:1.1rem}.notice{padding:var(--space-stack-md);border-radius:.65rem;background:#fef2f2;color:#b91c1c}.empty-card{min-height:14rem;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;background:#fff;border:1px solid #dbe1e8;border-radius:.9rem;color:#64748b;padding:var(--space-stack-2xl)}.empty-card div{display:grid;place-items:center;width:3rem;height:3rem;border-radius:50%;background:#ecfdf5;color:#047857;font-size:1.5rem;font-weight:700}.empty-card h2{color:#334155;margin:var(--space-stack-md) 0 var(--space-stack-xs)}.queue{display:grid;gap:var(--space-stack-sm)}.queue-item{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:var(--space-inline-lg);background:#fff;border:1px solid #dbe1e8;border-radius:.8rem;padding:var(--space-stack-lg) var(--space-stack-xl)}.queue-item:hover{border-color:#bfdbfe;box-shadow:0 3px 12px #1d4ed812}.item-icon{display:grid;place-items:center;width:2.5rem;height:2.5rem;border-radius:.65rem;background:#eff6ff;color:#1d4ed8}.item-copy h2{font-size:1rem;margin:0}.item-copy p:not(.item-type),.item-copy small{margin:var(--space-stack-xs) 0 0;color:#64748b;line-height:1.4}.item-copy small{display:block;font-weight:700;color:#475569}@media(max-width:650px){.attention-workspace>header{align-items:stretch;flex-direction:column}.queue-item{grid-template-columns:auto 1fr}.queue-item .primary{grid-column:1/-1;width:100%}.refresh{align-self:flex-start}}
.review-backdrop{position:fixed;inset:0;z-index:90;background:rgb(24 32 28 / .28);display:flex;align-items:center;justify-content:center;padding:1rem}.review-dialog{width:min(42rem,100%);max-height:90vh;overflow:auto;background:var(--surface-overlay);border:1px solid var(--border);border-radius:1rem;padding:1.3rem;box-shadow:var(--shadow-overlay)}.review-dialog h2{margin:.15rem 0 .7rem}.instruction,.score{padding:.75rem;border:1px solid var(--border-muted);background:var(--surface-muted);border-radius:.6rem}.quiet{color:#64748b;line-height:1.45}.answers{padding-left:1.2rem}.answers li{padding:.75rem .1rem;border-bottom:1px solid var(--border-muted)}.answers strong,.answers span{display:block}.answers span{margin-top:.25rem;color:#475569}.review-dialog footer{display:flex;justify-content:flex-end;gap:.5rem;margin-top:1rem}

/* Queue items are operational panels, not floating cards. */
.refresh{border-color:var(--border);background:var(--surface-elevated)}.refresh:hover{background:var(--surface-subtle);border-color:var(--border-strong)}.refresh:focus-visible,.primary:focus-visible{outline:2px solid #2563eb;outline-offset:2px}.empty-card{background:var(--surface);border-color:var(--border-muted)}.queue{gap:0;border-top:1px solid var(--border-muted);border-bottom:1px solid var(--border-muted);background:var(--surface)}.queue-item{background:var(--surface);border:0;border-bottom:1px solid var(--border-muted);border-radius:0}.queue-item:last-child{border-bottom:0}.queue-item:hover{background:var(--surface-subtle);box-shadow:none}.item-icon{background:var(--surface-muted);color:#1d4ed8}
</style>
