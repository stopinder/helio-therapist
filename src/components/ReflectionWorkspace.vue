    ...
    <form v-if="localView === 'main'" class="journal" @submit.prevent="saveReflection">
      ...
      <div class="action-bar">
        ...
        <div class="save-actions">
          <button type="button" class="secondary-action" :disabled="generatingSummary || saving || !hasReflectionText(body)" @click="summariseCurrentAttempt">
          ...
          <div class="summary-section border-t border-border pt-6">
            ...
            <div v-else class="summary-actions">
              <button 
                ...
                :disabled="generatingSummary || !hasReflectionText(selectedReflection.body)"
...
const hasReflectionText = value => Boolean(String(value || '').trim())
...
async function summariseCurrentAttempt() {
  if (!hasReflectionText(body.value)) return
...
function summariseFromDetail(reflection) {
  if (!hasReflectionText(reflection.body)) return
  openSummary(reflection, true)
}
