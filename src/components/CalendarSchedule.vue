...
.event-copy .appointment-status{color:#475569;font-weight:600}.event-actions .open-client-action{display:inline-flex;align-items:center;min-height:2.25rem;padding:.45rem .65rem;border:1px solid #bfdbfe;border-radius:.5rem;color:#1d4ed8;font-size:.85rem;font-weight:700;text-decoration:none;background:#fff}
</style>
