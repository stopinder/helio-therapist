...
onMounted(() => { loadEvents(); window.addEventListener('online', loadEvents) })
onUnmounted(() => { if (retryTimer) window.clearTimeout(retryTimer); window.removeEventListener('online', loadEvents) })
</script>
