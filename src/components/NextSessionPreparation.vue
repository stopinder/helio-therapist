...
<style scoped>
.next-session{margin:0 0 var(--space-stack-lg);padding:var(--space-stack-xl);background:#f8fbff;border:1px solid #bfdbfe;border-radius:.9rem;color:#1e3a5f}.next-session__heading{display:flex;align-items:baseline;justify-content:space-between;gap:var(--space-inline-lg)}.eyebrow{margin:0 0 var(--space-stack-xs);text-transform:uppercase;letter-spacing:.08em;color:#64748b}.next-session h2{margin:0}.next-session h2 span{color:#526074}.preparation-context{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:var(--space-stack-md);margin:var(--space-stack-lg) 0}.preparation-context div{padding:var(--space-stack-md);background:#fff;border:1px solid #dbeafe;border-radius:.65rem}.preparation-context dt{color:#64748b}.preparation-context dd{margin:var(--space-stack-xs) 0 0;color:#334155}.primary{border:1px solid #2563eb;border-radius:.55rem;background:#2563eb;color:#fff;padding:.65rem .9rem}@media(max-width:700px){.next-session__heading{align-items:flex-start;flex-direction:column;gap:var(--space-stack-xs)}.preparation-context{grid-template-columns:1fr}.primary{width:100%}}
</style>
