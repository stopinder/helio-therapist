...
<style scoped>
.next-session{margin:0 0 var(--space-stack-lg);padding:var(--space-stack-xl);background:var(--surface);border:1px solid var(--border);border-radius:.9rem;color:var(--text-primary)}.next-session__heading{display:flex;align-items:baseline;justify-content:space-between;gap:var(--space-inline-lg)}.eyebrow{margin:0 0 var(--space-stack-xs);text-transform:uppercase;letter-spacing:.08em;color:var(--text-muted)}.next-session h2{margin:0}.next-session h2 span{color:var(--text-secondary)}.preparation-context{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:var(--space-stack-md);margin:var(--space-stack-lg) 0}.preparation-context div{padding:var(--space-stack-md);background:var(--surface-muted);border:1px solid var(--border-muted);border-radius:.65rem}.preparation-context dt{color:var(--text-muted)}.preparation-context dd{margin:var(--space-stack-xs) 0 0;color:var(--text-secondary)}.primary{border:1px solid var(--action-link);border-radius:.55rem;background:var(--action-link);color:var(--surface-elevated);padding:.65rem .9rem}.primary:focus-visible{outline:2px solid var(--action-link);outline-offset:2px}@media(max-width:700px){.next-session__heading{align-items:flex-start;flex-direction:column;gap:var(--space-stack-xs)}.preparation-context{grid-template-columns:1fr}.primary{width:100%}}
</style>
