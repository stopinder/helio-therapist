...
const openSession = async () => {
  ...
  try {
    ...
    sessionOpenError.value = error?.code === 'CLIENT_ARCHIVED' ? 'Restore this client before opening a session.' : 'Couldn’t open the session workspace. Please try again.';
  } finally {
