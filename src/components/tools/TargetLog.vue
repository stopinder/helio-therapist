...
<template>
  <div class="p-6 bg-white rounded-lg shadow-sm border border-[#d9dce1] max-w-4xl mx-auto">
    <h2 class="text-h3 font-semibold text-[#2c3e50] mb-3">EMDR Target Log</h2>
        ...
        <div class="flex justify-between items-start">
          <div class="flex-1">
            ...
            <div class="grid grid-cols-2 gap-3 mb-2">
              <div>
                <label class="block text-caption text-slate-500 mb-0.5">SUD (0–10)</label>
                <input
                    v-model="t.sud"
                    type="number"
                    min="0"
              ...
              <div>
                <label class="block text-caption text-slate-500 mb-0.5">VOC (1–7)</label>
                <input
                    v-model="t.voc"
                    type="number"
                    min="1"
