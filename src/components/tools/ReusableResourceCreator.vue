...
<style scoped>
.add-resource{margin:.9rem 0;padding:.75rem;border:1px solid #dbe1e8;border-radius:.65rem;background:#f8fafc}.add-resource summary{cursor:pointer;font-weight:700;color:#334155}.creator-fields label{display:block;margin:.8rem 0;font-size:.85rem;font-weight:700;color:#334155}.creator-fields input,.creator-fields select{box-sizing:border-box;width:100%;margin-top:.35rem;padding:.7rem;border:1px solid #cfd7e2;border-radius:.55rem;font:inherit;font-weight:400}.secondary{border:1px solid #d7dde6;border-radius:.55rem;padding:.6rem .9rem;background:#fff;color:#334155;font-weight:600}.creator-error{margin:.75rem 0;padding:.7rem .8rem;border:1px solid #fecaca;background:#fff7f7;border-radius:.55rem;color:#991b1b}
</style>
