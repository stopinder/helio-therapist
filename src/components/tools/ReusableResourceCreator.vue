...
<style scoped>
.add-resource{margin:.9rem 0;padding:.75rem;border:1px solid var(--border-muted);border-radius:.65rem;background:var(--surface-muted)}.add-resource summary{cursor:pointer;font-weight:700;color:var(--text-secondary)}.creator-fields label{display:block;margin:.8rem 0;font-size:.85rem;font-weight:700;color:var(--text-secondary)}.creator-fields input,.creator-fields select{box-sizing:border-box;width:100%;margin-top:.35rem;padding:.7rem;border:1px solid var(--border);border-radius:.55rem;font:inherit;font-weight:400}.secondary{border:1px solid var(--border);border-radius:.55rem;padding:.6rem .9rem;background:var(--surface-elevated);color:var(--text-secondary);font-weight:600}.creator-error{margin:.75rem 0;padding:.7rem .8rem;border:1px solid var(--state-danger);background:var(--state-danger-surface);border-radius:.55rem;color:var(--state-danger)}
</style>
