...
.timeline-actions,.session-actions{display:flex;flex-wrap:wrap;gap:.45rem}.timeline-actions{justify-content:flex-end}.timeline-actions .secondary,.session-actions .secondary{font-size:.78rem;padding:.5rem .65rem}.session-actions{align-items:center;margin:.8rem 0;padding:.7rem 0;border-top:1px solid #edf0f4;border-bottom:1px solid #edf0f4}.session-actions span{width:100%;font-size:.72rem;text-transform:uppercase;letter-spacing:.07em;font-weight:700;color:#64748b}
...
.record-header,.focus-card,.latest-card,.appointment-card,.recent-card,.section-card,.timeline-card{background:var(--surface);border-color:var(--border-muted);box-shadow:none}.record-tabs{border-color:var(--border-muted)}.secondary{background:var(--surface-elevated);border-color:var(--border);}.secondary:hover{background:var(--surface-subtle);border-color:var(--border-strong)}.primary:focus-visible,.secondary:focus-visible,.text-action:focus-visible{outline:2px solid #2563eb;outline-offset:2px}.focus-card textarea,.session-editor textarea{background:var(--surface-elevated);border-color:var(--border)}.focus-card textarea:focus,.session-editor textarea:focus{border-color:var(--border-strong);box-shadow:0 0 0 3px #dbeafe}.continuity-link,.session-context{background:var(--surface-muted);border-color:var(--border-muted)}.session-row,.timeline-event{background:transparent;border-color:var(--border-muted)}.timeline-event:hover{background:var(--surface-subtle)}.timeline-marker{background:var(--surface-muted)}.session-actions,.empty-inline{border-color:var(--border-muted)}.modal-backdrop{background:rgb(24 32 28 / .28)}.session-editor,.share-link{background:var(--surface-overlay);border:1px solid var(--border);box-shadow:var(--shadow-overlay)}.ai-boundary{background:var(--surface-muted);border-color:var(--border-muted)}
</style>
