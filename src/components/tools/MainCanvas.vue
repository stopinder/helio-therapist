  ...
  <section v-if="selectedClient" class="client-record">
    ...
    <main v-if="activeTab === 'timeline'" class="overview">
      ...
      <section class="timeline-card">
        <div class="card-heading"><div><p class="eyebrow">Timeline</p><h2>Since your last session</h2><p class="quiet-copy">A chronological view of the client’s work. It shows clinically useful events, not an audit log.</p></div></div>
...
watch(() => props.selectedClient?.id, () => { activeTab.value = 'timeline'; preparingFor.value = null; closeEditor(); cancelFocusEdit(); documents.value = [] })
