...
<style scoped>
.client-directory{max-width:52rem;margin:0 auto;color:#2c3e50}.client-directory header{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;margin-bottom:1.2rem}.client-directory h1{margin:0}.client-directory header p{color:#64748b;margin:.25rem 0 0}.primary{border:0;border-radius:.55rem;background:#2563eb;color:white;padding:.65rem .9rem;white-space:nowrap}.search-box{display:flex;align-items:center;gap:.65rem;background:white;border:1px solid #d9dfe8;border-radius:.6rem;padding:0 .85rem;margin-bottom:1.4rem;color:#64748b}.search-box:focus-within{border-color:#60a5fa;box-shadow:0 0 0 3px #dbeafe}.search-box input{width:100%;border:0;outline:0;background:transparent;padding:.72rem 0}.recent-section{margin-bottom:1.5rem}.recent-section h2,.list-heading h2{color:#526074;margin:0}.client-list{border-top:1px solid #dfe5ec;border-bottom:1px solid #dfe5ec;background:white}.client-row{display:grid;grid-template-columns:2rem minmax(0,1fr);align-items:center;gap:.65rem;width:100%;min-height:52px;padding:.45rem .65rem;text-align:left;border:0;border-bottom:1px solid #edf0f4;background:white;color:#2c3e50;transition:background .14s}.client-row:last-child{border-bottom:0}.client-row:hover,.client-row:focus-visible,.client-row.keyboard-active{background:#f4f8ff;outline:none}.client-row.selected{background:#f7fbff}.avatar{display:flex;width:2rem;height:2rem;align-items:center;justify-content:center;border-radius:50%;background:#e7edf5;color:#334155}.client-copy{display:flex;align-items:baseline;gap:.5rem;min-width:0}.client-copy strong{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.client-copy small{color:#708096;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.all-clients{margin-top:.25rem}.list-heading{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:.45rem}.list-heading h2 span{font-weight:500;color:#8793a5;margin-left:.25rem}.directory-controls{display:flex;gap:.4rem}.compact-control select{appearance:auto;border:0;background:transparent;color:#64748b;padding:.28rem .15rem}.compact-control select:hover{color:#334155}.empty-state{min-height:12rem;border:1px dashed #d9dfe8;border-radius:.7rem;background:white;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;color:#64748b}.empty-state div{font-size:1.5rem;opacity:.4}.empty-state h2{color:#475569;margin:.4rem 0 .15rem}.empty-state p{margin:0}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}@media(max-width:700px){.client-directory header{align-items:center}.client-copy{gap:.35rem}.list-heading{align-items:center}.directory-controls{gap:.2rem}.client-row{min-height:50px}}
