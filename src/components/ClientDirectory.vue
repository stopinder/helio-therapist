...
<style scoped>
.client-directory{max-width:52rem;margin:0 auto;color:var(--text-primary)}.client-directory header{display:flex;align-items:flex-start;justify-content:space-between;gap:var(--space-inline-lg);margin-bottom:var(--space-stack-xl)}.client-directory h1{margin:0}.client-directory header p{color:var(--text-muted);margin:var(--space-stack-xs) 0 0}.primary{border:0;border-radius:.55rem;background:var(--action-link);color:var(--text-on-action);padding:.65rem .9rem;white-space:nowrap}.search-box{display:flex;align-items:center;gap:var(--space-inline-md);background:var(--surface-elevated);border:1px solid var(--border);border-radius:.6rem;padding:0 var(--space-inline-lg);margin-bottom:var(--space-stack-xl);color:var(--text-muted)}.search-box:focus-within{border-color:var(--border-strong);box-shadow:0 0 0 3px var(--state-selected)}.search-box input{width:100%;border:0;outline:0;background:transparent;padding:.72rem 0}.recent-section{margin-bottom:var(--space-stack-xl)}.recent-section h2,.list-heading h2{color:var(--text-secondary);margin:0}.client-list{border-top:1px solid var(--border-muted);border-bottom:1px solid var(--border-muted);background:var(--surface)}.client-row{display:grid;grid-template-columns:2rem minmax(0,1fr);align-items:center;gap:var(--space-inline-md);width:100%;min-height:52px;padding:var(--space-stack-sm) var(--space-inline-md);text-align:left;border:0;border-bottom:1px solid var(--border-muted);background:var(--surface);color:var(--text-primary);transition:background .14s}.client-row:last-child{border-bottom:0}.client-row:hover,.client-row.keyboard-active{background:var(--surface-subtle);outline:none}.client-row:focus-visible{background:var(--surface-subtle);outline:2px solid var(--action-link);outline-offset:-2px}.client-row.selected{background:var(--surface-subtle);box-shadow:inset 3px 0 0 var(--action-link)}.avatar{display:flex;width:2rem;height:2rem;align-items:center;justify-content:center;border-radius:50%;background:var(--surface-muted);color:var(--text-secondary)}.client-copy{display:flex;align-items:baseline;gap:var(--space-inline-sm);min-width:0}.client-copy strong{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.client-copy small{color:var(--text-muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.all-clients{margin-top:var(--space-stack-xs)}.list-heading{display:flex;align-items:center;justify-content:space-between;gap:var(--space-inline-lg);margin-bottom:var(--space-stack-sm)}.list-heading h2 span{font-weight:500;color:var(--text-muted);margin-left:var(--space-inline-xs)}.directory-controls{display:flex;gap:var(--space-inline-xs)}.compact-control select{appearance:auto;border:0;background:transparent;color:var(--text-muted);padding:.28rem .15rem}.compact-control select:hover{color:var(--text-secondary)}.empty-state{min-height:12rem;border:1px dashed var(--border);border-radius:.7rem;background:var(--surface);display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;color:var(--text-muted);padding:var(--space-stack-xl)}.empty-state div{font-size:1.5rem;opacity:.4}.empty-state h2{color:var(--text-secondary);margin:var(--space-stack-sm) 0 var(--space-stack-xs)}.empty-state p{margin:0}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}@media(max-width:700px){.client-directory header{align-items:center}.client-copy{gap:var(--space-inline-xs)}.list-heading{align-items:center}.directory-controls{gap:var(--space-inline-xs)}.client-row{min-height:50px}}
.secondary{border:1px solid var(--border);border-radius:.55rem;background:var(--surface-elevated);color:var(--text-secondary);font-weight:600;padding:.6rem .8rem;white-space:nowrap}
</style>
