      ...
      >
        ...
        <div class="relative shrink-0 border-b border-border-muted bg-sidebar px-3 py-2">
          ...
          >
            ...
            <span class="min-w-0 flex-1 truncate type-ui font-semibold text-ink">
    ...
    <div class="flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      <header class="flex h-16 shrink-0 items-center justify-between border-b border-border-muted bg-surface px-inline-lg md:px-6">
        ...
        <div class="flex shrink-0 items-center gap-2">
          ...
          >
            <time
                class="type-ui tabular-nums font-medium text-ink-secondary"
          ...
          <span
              class="mx-1 hidden h-6 w-px bg-border-muted md:block"
              aria-hidden="true"
          ></span>
