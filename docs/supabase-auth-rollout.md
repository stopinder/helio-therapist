...
1. In Supabase Authentication > URL Configuration, set:
   - Site URL: `https://therapyworks.works`
   - Redirect URL: `https://therapyworks.works/**`
...
4. Confirm Vercel Production contains:
   ...
   - `GOOGLE_REDIRECT_URI=https://therapyworks.works/api/google/callback`
   - `APP_URL=https://therapyworks.works`
