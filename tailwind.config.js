  ...
  theme: {
    extend: {
      colors: {
        ...
        avatar: 'var(--surface-avatar)', backdrop: 'var(--surface-backdrop)', 'brand-amber': 'var(--brand-amber)', 'brand-amber-soft': 'var(--brand-amber-soft)', 'brand-sage-soft': 'var(--brand-sage-soft)',
      },
