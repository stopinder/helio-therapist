  ...
  theme: {
    extend: {
      colors: {
        ...
        'brand-amber-soft': 'var(--brand-amber-soft)',
        'brand-sage-soft': 'var(--brand-sage-soft)',

        midnight: 'var(--midnight)',
        'midnight-deep': 'var(--midnight-deep)',
        'midnight-steel': 'var(--midnight-steel)',
        'midnight-mist': 'var(--midnight-mist)',
        'midnight-cloud': 'var(--midnight-cloud)',
        'midnight-frost': 'var(--midnight-frost)',
        'midnight-amber': 'var(--midnight-amber)',
        'midnight-amber-soft': 'var(--midnight-amber-soft)',
      },
      ...
      fontSize: {
        display: ['2.625rem', { lineHeight: '2.9rem', letterSpacing: '-0.035em' }],
        h1: ['2rem', { lineHeight: '2.35rem', letterSpacing: '-0.025em' }],
        h2: ['1.375rem', { lineHeight: '1.8rem', letterSpacing: '-0.015em' }],
        h3: ['1.0625rem', { lineHeight: '1.5rem' }],
        body: ['0.9375rem', { lineHeight: '1.55rem' }],
        'body-long': ['1rem', { lineHeight: '1.8rem' }],
        'body-sm': ['0.8125rem', { lineHeight: '1.3rem' }],
        caption: ['0.75rem', { lineHeight: '1.05rem' }],
        overline: ['0.6875rem', { lineHeight: '1rem', letterSpacing: '0.11em' }],
      },
