...
export function encryptBookingUrl(value) {
...
export function decryptBookingUrl(value) {
  const [ivValue, tagValue, encryptedValue] = String(value || '').split('.');
  if (!ivValue || !tagValue || !encryptedValue) throw new Error('Invalid encrypted booking URL');
